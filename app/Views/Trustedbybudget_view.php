					...
					<div class="items-blog-tab-heading row">
						<div class="col-12">
							<ul class="nav items-blog-tab-menu">
								<li class=""><a href="#tab-1" class="" data-toggle="tab">All</a></li>
							...
							<div class="row" id="cars-containers">
										...
										<div class="card-body pb-0">
											<div class="item-card2">
												<div class="item-card2-desc">
													...
													<div class="d-flex">
														<a href="">
															<p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-map-marker text-danger mr-2"></i>Mumbai</p>
														</a>
														<span class="ml-3 pb-0 pt-0 mb-2 mt-2 font-weight-bold">₹.5,00,000</span>
													</div>
								...
								<div class="col-xl-4 col-lg-4 col-md-12">
									<div class="card">
										...
										<div class="item-card8-img  br-tr-6 br-tl-6">
											<img src="../assets/images/media/cars/p1.jpg" alt="img" class="cover-image">
										</div>
										<div class="item-card8-overlaytext">
								...
								<div class="col-xl-4 col-lg-4 col-md-12">
									<div class="card">
										...
										<div class="item-card8-img  br-tr-6 br-tl-6">
											<img src="../assets/images/media/cars/maruti.jpg" alt="img" class="cover-image">
										</div>
										<div class="item-card8-overlaytext">
											<h6 class="bg-primary fs-20 mb-0">₹.5,00,000</h6>
										</div>
