		...
		<script src="<?php echo URL_JS.URL_SEPARATOR.'jquery.sparkline.min.js'; ?>"></script>

		<!-- Circle Progress Js-->
		<script src="<?php echo URL_JS.URL_SEPARATOR.'circle-progress.min.js'; ?>"></script>

		<!-- Star Rating Js-->
		<script src="<?php echo URL_SEPARATOR; ?>assets/plugins/rating/jquery.rating-stars.js"></script>
