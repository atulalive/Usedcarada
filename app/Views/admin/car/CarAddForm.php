        ...
        <div class="app-content">
            <div class="side-app">
                <div class="row" style="margin-top:95px;">
                    ...
                    <form action="<?php echo base_url('public/admin/CarAdd'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <?php echo csrf_field() ?>
                        <div class="col-12">
                            <!-- Product Basic Info -->
                            <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select <?php echo ($validation->getError('brand')) ? "is-invalid" : ""; ?>" id="brand" name="brand" placeholder="" onchange="loadModelList(this.value)">
                                                    <option value="">--Select Brand--</option>
                                                    <?php
                                                    if(isset($brand)){
                                                        foreach ($brand as $brand_val) {
                                                            echo '<option value="' . $brand_val['id'] . '">' . ucwords($brand_val['name']) . '</option>';
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select BrandModal <?php echo ($validation->getError('model')) ? "is-invalid" : ""; ?>" id="model" name="model" placeholder="" onchange="loadSubModelList(this.value)">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select BrandSubModal <?php echo ($validation->getError('submodel')) ? "is-invalid" : ""; ?>" id="submodel" name="submodel" placeholder="" >
                                                    <option value="">--Select Brand Sub Model--</option>
                                                </select>
                                                <?php if ($validation->getError('submodel')) : ?>
                                                    <div class="invalid-feedback">
                                                        <?= $validation->getError('submodel') ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select <?php echo ($validation->getError('cartype')) ? "is-invalid" : ""; ?>" id="cartype" name="cartype" placeholder="" >
                                                    <option value="">--Select Car Type--</option>
                                                    <?php
                                                    if(isset($sub_category)){
                                                        foreach ($sub_category as $sub_category_val) {
                                                            echo '<option value="' . $sub_category_val['id'] . '">' . ucwords($sub_category_val['name']) . '</option>';
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select <?php echo ($validation->getError('city')) ? "is-invalid" : ""; ?>" id="city" name="city" placeholder="">
                                                    <option value="">--Select City--</option>
                                                    <?php
                                                    if(isset($top_cities)){
                                                        foreach ($top_cities as $city_val) {
                                                            echo '<option value="' . $city_val['id'] . '">' . ucwords($city_val['name']) . '</option>';
                                                        }
                                                    }
                                                    ?>
                                                </select>
...
<script>
        ...
        function loadModelList(val){
            $.post(
                '<?php echo base_url('public/admin/FindCarModal');?>',
                {id: val}, 
                function(result) {
                    $('.BrandModal').html(result);
                }
            );
        }

        function loadSubModelList(val){
            $.post(
                '<?php echo base_url('public/admin/FindCarSubModal');?>',
                {id: val}, 
                function(result) {
                    $('.BrandSubModal').html(result);
                }
            );
        }
