					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Car Bodies</h3>
                                <button type="button" class="btn btn-success ml-auto" data-toggle="modal" data-target="#CarModal"><i class="fa fa-plus" aria-hidden="true"></i> Car Bodies</button>
							</div>
							<div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Car Bodies</h5>
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    var CarTable = $('#tbl-students-data').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo base_url('public/admin/CarBodies_loaddata');?>", // json datasource
            type: "post",
            data: {
        ...
        $(document).on('click','.CarBodiesSave',function(){
            ...
            if(name != '' || slug != ''){
                $.ajax({
                    url: '<?php echo base_url('public/admin/CarBodies_Save');?>',
                    type: 'post',
            ...
            if(this.name == "deleteButton") {
				Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.post(
                            '<?php echo base_url('public/admin/CarBodiesDelete');?>',
                            {id: id}, 
                            function(result) {
                                CarTable.draw();
        ...
        $("#tbl-students-data tbody").on('click', '.edit', function() {
            ...
            if(this.name == "edit") {
                $.post(
                    '<?php echo base_url('public/admin/CarBodiesEdit');?>',
                    {id: id}, 
                    function(result) {
