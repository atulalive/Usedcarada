					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Car Prices</h3>
                                <button type="button" class="btn btn-success ml-auto" data-toggle="modal" data-target="#CarModal"><i class="fa fa-plus" aria-hidden="true"></i> Car Prices</button>
							</div>
							<div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Car Prices</h5>
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    var CarTable = $('#tbl-students-data').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo base_url('public/admin/CarPrices_loaddata');?>", // json datasource
            type: "post",
            data: {
        ...
        $(document).on('click','.CarBodiesSave',function(){
            ...
            if(name != '' || slug != ''){
                $.ajax({
                    url: '<?php echo base_url('public/admin/CarPrices_Save');?>',
                    type: 'post',
            ...
            if(this.name == "deleteButton") {
				Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.post(
                            '<?php echo base_url('public/admin/CarPricesDelete');?>',
                            {id: id}, 
                            function(result) {
                                CarTable.draw();
        ...
        $("#tbl-students-data tbody").on('click', '.edit', function() {
            ...
            if(this.name == "edit") {
                $.post(
                    '<?php echo base_url('public/admin/CarPricesEdit');?>',
                    {id: id}, 
                    function(result) {
