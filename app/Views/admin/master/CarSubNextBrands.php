					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
                                ...
                                <a href="<?php echo base_url('public/admin/addCarSubNextBrandView');?>" class="btn btn-success ml-auto"><i class="fa fa-plus" aria-hidden="true"></i> Car Sub Next Brands</a>
							</div>
							<div class="card-body">
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    var CarTable = $('#CarBrandTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo base_url('public/admin/CarSubNextBrandList');?>", // json datasource
            type: "post",
            data: {
            ...
            if(this.name == "deleteButton") {
				Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.post(
                            '<?php echo base_url('public/admin/CarSubNextBrandDelete');?>',
                            {id: id}, 
                            function(result) {
                                CarTable.draw();
