					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
                                ...
                                <a href="<?php echo base_url('public/admin/CarBrands');?>" class="btn btn-success ml-auto"><i class="fa fa-arrow-left" aria-hidden="true"></i> Car Brand List</a>
							</div>
							<div class="card-body">
                                <?php $validation = \Config\Services::validation(); ?>
                                <form method="post" action="<?php echo base_url('public/admin/AddCarBrand');?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Name<span style="color:red;">*</span></label>
                                        <input type="text" class="form-control" name="name" value="<?php echo (isset($data['name']) && $data['name'] != '')? $data['name'] : '' ;?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Name">
                                        <input type="hidden" name="id" class="id" value="<?php echo (isset($data['id']) && $data['id'] != '')? $data['id'] : '' ;?>">
                                        <?php if($validation->getError('name')) { echo '<sapn style="color:red;">'.$validation->getError('name').'</span>';}?>
                                    </div>
                                    <div class="form-group">
