...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Shortlisted Vehicles </h3>
	</div>
...
<div class="card-body">
		<div class="card-pay">
				...
				<dl class="card-text"style="padding-left:30%;">
					<img src="../assets/images/users/male/shortVehicle-Noshow.svg" class="brround" alt="user"><br><br>

					<dd>You have not shortlisted any vehicle</dd>
				</dl>

				<dl class="card-text"style="padding-left:30%;">
					<div class="col-xl-6 col-lg-6 col-sm-6 col-6"><a href="#" class="btn btn-danger" data-toggle="modal" data-target="#LgoinRegister"> Browse Cars</a>
				</dl>
